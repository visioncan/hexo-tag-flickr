...
var enabledCache  = (!cacheFilePath && !cachePeriod) ? false : true;
...
// get image size
function getImageSize( flickrJson, photo_id, photo_size ){
        ...
        https.get(url, function (res) {
          ...
          res.on('end', function () {
            ...
            if (json.stat === 'ok') {
                ...
                var imgSize = getImageSize( json, tag.id, tag.size );
